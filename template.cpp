...
if(fs::exists(file)){std::cerr<<"File "<<file<<" already there. It will not be overwritten by rule writer_file_0.\n";return WRITER_STATUS_SKIP;}
...
fs::path file = dir / name;
if(fs::exists(file)){std::cerr<<"File "<<file<<" already there. It will not be overwritten by rule writer_file_1.\n";return WRITER_STATUS_SKIP;}
std::ofstream out(file, std::ios::binary);
out.close();
return WRITER_STATUS_OK;
}
...
fs::path file = dir / name;
if(fs::exists(file)){std::cerr<<"File "<<file<<" already there. It will not be overwritten by rule writer_file_2.\n";return WRITER_STATUS_SKIP;}
std::ofstream out(file, std::ios::binary);
...
fs::path file = dir / name;
if(fs::exists(file)){std::cerr<<"File "<<file<<" already there. It will not be overwritten by rule writer_file_3.\n";return WRITER_STATUS_SKIP;}
std::ofstream out(file, std::ios::binary);
...
fs::path file = dir / name;
if(fs::exists(file)){std::cerr<<"File "<<file<<" already there. It will not be overwritten by rule writer_file_4.\n";return WRITER_STATUS_SKIP;}
std::ofstream out(file, std::ios::binary);
out.close();
return WRITER_STATUS_OK;
}
...
fs::path file = dir / name;
if(fs::exists(file)){std::cerr<<"File "<<file<<" already there. It will not be overwritten by rule writer_file_5.\n";return WRITER_STATUS_SKIP;}
std::ofstream out(file, std::ios::binary);
...
fs::path file = dir / name;
if(fs::exists(file)){std::cerr<<"File "<<file<<" already there. It will not be overwritten by rule writer_file_6.\n";return WRITER_STATUS_SKIP;}
std::ofstream out(file, std::ios::binary);
...
fs::path file = dir / name;
if(fs::exists(file)){std::cerr<<"File "<<file<<" already there. It will not be overwritten by rule writer_file_7.\n";return WRITER_STATUS_SKIP;}
std::ofstream out(file, std::ios::binary);
